...
//   TH1D *hBck = new TH1D(Form("hBck%d",count),"",40,5,6);
   ...
   cout<<"sigma: ";
   if(f->GetParameter(2)>f->GetParameter(8)) cout<<f->GetParameter(8)<<"  ||  "<<f->GetParameter(2)<<endl;
   else cout<<f->GetParameter(2)<<"  ||  "<<f->GetParameter(8)<<endl;
...
void fitB0sw(TString infname="",bool doweight = 1)
{
