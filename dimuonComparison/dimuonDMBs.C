...
void dimuonLoop(float ptmin, float ptmax, float ymin, float ymax, int i)
{
  ...
  c->SaveAs(Form("MuonResult/plot_Bs_chi2_trkPt/dimuon_yDM_%i.pdf",i));
  //c->SaveAs(Form("MuonResult/plot_Bs_chi2_trkPt/dimuon_DM_%i.pdf",i));
  //c->SaveAs("MuonResult/plot_Bs_chi2_trkPt/dimuon_DM_incl_1.pdf");
