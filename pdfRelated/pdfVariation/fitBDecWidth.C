...
//   cout <<mass->Integral(0,1.2)<<" "<<mass->IntegralError(0,1.2)<<endl;
   ...
   //c->SaveAs(Form("PDFVariation/data/width0p8/ResultsBplus/BMass-%d.pdf",count));
   c->SaveAs(Form("PDFVariation1Bin/data/width0p8/ResultsBplus/BMass-%d.pdf",count));

   return mass;
}

void fitBDecWidth(TString infname="",bool doweight = 1)
{
