...
void buildBranch(TTree* nt){
  ...
  nt->Branch("pt1",pt1, "pt1[size]/F");
  nt->Branch("pt2",pt2, "pt2[size]/F");
  nt->Branch("p1",p1, "p1[size]/F");
  nt->Branch("p2",p2, "p2[size]/F");
  nt->Branch("eta1",eta1, "eta1[size]/F");
  nt->Branch("eta2",eta2, "eta2[size]/F");
  nt->Branch("phi1",phi1, "phi1[size]/F");
  nt->Branch("phi2",phi2, "phi2[size]/F");
