...
void TnPHisto_MC_new2() {

TFile* hout = new TFile("TNPHisto_TagMu3_TrgProbeMu3_MC_new2.root","RECREATE");
...
Double_t MuIDetabin1[7] = {0.43,0.797,0.928,0.969,0.967,0.984,0.93};
Double_t MuIDetabin1Err[7] = {0.01,0.008,0.006,0.005,0.007,0.004,0.07};
...
Double_t MuIDetabin3Err[7] = {0.01,0.009,0.007,0.007,0.006,0.007,0.05};
