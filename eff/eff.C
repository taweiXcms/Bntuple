...
void AcceptedCand(TTree *ntGen, TH1F* gen_bsig_pt, TH1F* gen_bsig_y, bool IsPpb);
...
//  double yBins[nEtaBins+1] = {-2.395, -1.47, -0.47, 0.53, 1.465};
  ...
  TH1F* reco_bsig_y2 = new TH1F("reco_bsig_y2", "", nEtaBins,yBins);
  TH1F* gen_bsig_pt2 = new TH1F("gen_bsig_pt2", "", nBins,ptBins);
  TH1F* gen_bsig_y2 = new TH1F("gen_bsig_y2", "", nEtaBins,yBins);
...
/*
  ...
  TH1F* reco_bsig_pt2 = new TH1F("reco_bsig_pt2", "", 20, ptBins[0], ptBins[nBins]);
  TH1F* reco_bsig_y2 = new TH1F("reco_bsig_y2", "", 20, yBins[0], yBins[nEtaBins]);
  TH1F* gen_bsig_pt2 = new TH1F("gen_bsig_pt2", "", 20, ptBins[0], ptBins[nBins]);
  TH1F* gen_bsig_y2 = new TH1F("gen_bsig_y2", "", 20, yBins[0], yBins[nEtaBins]);
*/

//  TH2F* sct_pt_y = new TH2F("sct_pt_y","",nEtaBins, yBins, nBins, ptBins);
//  TH2F* sct_pt_y2 = new TH2F("sct_pt_y2","",nEtaBins, yBins, nBins, ptBins);
  TH2F* sct_pt_y = new TH2F("sct_pt_y","",20,-1.93, 1.93, 20, 10, 60);
  TH2F* sct_pt_y2 = new TH2F("sct_pt_y2","",20,-1.93, 1.93, 20, 10, 60);
...
//  nevents_total = 10000;
  ...
  AcceptedCand(ntGen, gen_bsig_pt, gen_bsig_y, true);
  AcceptedCand(ntGen2,gen_bsig_pt2, gen_bsig_y2, false);
