...
//   TString iNP="6.71675e+00*Gaus(x,5.30142e+00,8.42680e-02)/(sqrt(2*3.14159)*8.42680e-02)+4.06744e+01*Gaus(x,5.00954e+00,8.11305e-02)/(sqrt(2*3.14159)*8.11305e-02)+5.99974e-01*(2.376716*Gaus(x,5.640619,0.095530)/(sqrt(2*3.14159)*0.095530)+3.702342*Gaus(x,5.501706,0.046222)/(sqrt(2*3.14159)*0.046222))+1.31767e-01*(61.195688*Gaus(x,5.127566,0.087439)/(sqrt(2*3.14159)*0.087439)+58.943919*Gaus(x,5.246471,0.041983)/(sqrt(2*3.14159)*0.041983))";
   ...
   // With tktkMass - K*0mass<0.1
//   TString iNP="9.72337*Gaus(x,5.30142e+00,8.42680e-02)/(sqrt(2*3.14159)*8.42680e-02)+3.53914e1*Gaus(x,5.00954e+00,8.11305e-02)/(sqrt(2*3.14159)*8.11305e-02)+1.78234*(2.376716*Gaus(x,5.640619,0.095530)/(sqrt(2*3.14159)*0.095530)+1.48598*Gaus(x,5.501706,0.046222)/(sqrt(2*3.14159)*0.046222))+2.04453e-1*(61.195688*Gaus(x,5.127566,0.087439)/(sqrt(2*3.14159)*0.087439)+4.30123e1*Gaus(x,5.246471,0.041983)/(sqrt(2*3.14159)*0.041983))";

   // With tktkmass >0.85
   TString iNP="2.28629e1*Gaus(x,5.00954e+00+2.30765e-2,8.11305e-02)/(sqrt(2*3.14159)*8.11305e-02)+3.70689*Gaus(x,5.279-1.08353e-2,0.041983)/(sqrt(2*3.14159)*(0.041983))";
