...
Float_t genphi[MAX_XB];
Float_t geny[MAX_XB];
Float_t chi2cl[MAX_XB];//b vertex chi2 confidence level
Int_t isbestchi2[MAX_XB]; 
Int_t isbesttktkmass[MAX_XB];
Int_t kstar[MAX_XB]; 
...
Float_t genBsubsToPhiK[MAX_XB];
Float_t genBsubsToPhiPi[MAX_XB];
Float_t genB0ToK0star_K[MAX_XB];
Float_t genB0ToK0star_Pi[MAX_XB];
Float_t genB0ToKplusminus_K[MAX_XB];
Float_t genB0ToKplusminus_Pi[MAX_XB];

Float_t genBsubsTophi_K[MAX_XB];
Float_t genBsubsTophi_Pi[MAX_XB];
*/

//Muon Infomation
Float_t mu1TrackerMuArbitrated[MAX_XB];
Float_t mu2TrackerMuArbitrated[MAX_XB];
Float_t mu1eta[MAX_XB];
Float_t mu1phi[MAX_XB];
Float_t mu1y[MAX_XB];
Float_t mu1pt[MAX_XB];
Float_t mu1p[MAX_XB];
Float_t mu2eta[MAX_XB];
Float_t mu2phi[MAX_XB];
Float_t mu2y[MAX_XB];
Float_t mu2pt[MAX_XB];
Float_t mu2p[MAX_XB];
...
Double_t mu1dzPV[MAX_XB];
Double_t mu2dzPV[MAX_XB];
Double_t mu1dxyPV[MAX_XB];
Double_t mu2dxyPV[MAX_XB];
Int_t mu1InPixelLayer[MAX_XB];
Int_t mu2InPixelLayer[MAX_XB];
Int_t mu1InStripLayer[MAX_XB];
Int_t mu2InStripLayer[MAX_XB];
Int_t mu1InTrackerLayer[MAX_XB];
Int_t mu2InTrackerLayer[MAX_XB];
Double_t mu1normchi2[MAX_XB];
Double_t mu2normchi2[MAX_XB];
Double_t mu1Chi2ndf[MAX_XB];
Double_t mu2Chi2ndf[MAX_XB];

//Vertex Information
Float_t mumumass[MAX_XB];
Float_t mumueta[MAX_XB];
Float_t mumuphi[MAX_XB];
Float_t mumuy[MAX_XB];
Float_t mumupt[MAX_XB];
...
Float_t ujphi[MAX_XB];
Float_t ujy[MAX_XB];
Float_t ujlxy[MAX_XB];

//Tracks Information
Float_t trk1Pt[MAX_XB];
Float_t trk1Eta[MAX_XB];
Float_t trk1Phi[MAX_XB];
Float_t trk1Y[MAX_XB];
...
Float_t trk2Eta[MAX_XB];
Float_t trk2Phi[MAX_XB];
Float_t trk2Y[MAX_XB];
...
Float_t tktkmassKK[MAX_XB];
Float_t tktkvProb[MAX_XB];
Float_t tktkpt[MAX_XB];
Float_t tktketa[MAX_XB];
Float_t tktkphi[MAX_XB];
Float_t tktky[MAX_XB];
Float_t doubletmass[MAX_XB];
Float_t doubletpt[MAX_XB];
Float_t doubleteta[MAX_XB];
Float_t doubletphi[MAX_XB];
Float_t doublety[MAX_XB];
