...
void dimuonLoop(float ptmin, float ptmax, float ymin, float ymax)
{
  ...
  c->SaveAs("CandidateResult/Bplus_candidates_eff_incl.pdf");
  ...
  c1->SaveAs("CandidateResult/Bplus_candidates_compare_incl.pdf");
  ...
  c2->SaveAs("CandidateResult/Bplus_candidates_compare_sigreg.pdf");
